...
const TechStackCategory = ({ category, items }: TechStackCategoryProps) => {
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-2xl font-semibold capitalize gradient-text">{category} Technologies</h3>
  ...
  return (
    <section id="portfolio" className="min-h-screen py-20">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-purple-400">Portfolio Showcase</h2>
        ...
        <div className="flex items-start justify-between gap-3 text-sm">
          ...
          <TabsContent value="techstack">
            {techStackLoading ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-400">No tech stack items available yet.</p>
              </div>
            ) : (
              <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-12">
                {Object.entries(techStackByCategory).map(([category, items]) => (
