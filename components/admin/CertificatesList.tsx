      ...
      <Card className="glass-card border-0">
        <CardContent className="py-16 text-center">
          ...
          <Button asChild className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700">
            <Link href="/admin/certificates/new">Add Your First Certificate</Link>
          </Button>
        </CardContent>
      </Card>
    )
        ...
        >
          <Card className="glass-card border-0 hover:border-blue-400/50 transition-all duration-300 h-full flex flex-col group">
            ...
            <CardContent className="p-6 flex-1 flex flex-col">
              {/* Certificate Title */}
              <CardTitle className="text-white mb-2 line-clamp-2 text-lg">{certificate.title}</CardTitle>
                  ...
                  <AlertDialogContent className="bg-gray-900 border-gray-800">
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription className="text-gray-400">
                        ...
                        <span className="font-semibold text-white">"{certificate.title}"</span>? This action cannot be
                        undone.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
              ...
              <div className="pt-3 border-t border-white/10">
                ...
                >
                  <Link href={certificate.href} target="_blank" rel="noopener noreferrer">
