...
export async function getProjects(): Promise<DBProject[]> {
  try {
    ...
    throw new Error(
      `Error fetching projects: ${error instanceof Error ? error.message : String(error)}`,
    );
  }
}
...
export async function addProject(formData: FormData) {
  try {
    ...
    throw new Error(
      `Error adding project: ${error instanceof Error ? error.message : String(error)}`,
    );
  }
}
...
export async function updateProject(id: string, formData: FormData) {
  try {
    ...
    throw new Error(
      `Error updating project: ${error instanceof Error ? error.message : String(error)}`,
    );
  }
}
...
export async function deleteProject(id: string) {
  try {
    ...
    throw new Error(
      `Error deleting project: ${error instanceof Error ? error.message : String(error)}`,
    );
  }
}
